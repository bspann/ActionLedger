...
namespace ActionLedger.Infrastructure.Migrations
{
    ...
    [Migration("20260922185533_AddWebhookOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActionLedger.Domain.Actions.TrackedAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("ProposedActionId")
                        .HasColumnType("uuid")
                        .HasColumnName("proposed_action_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tracked_actions");

                    b.HasIndex("OwnerUserId")
                        .HasDatabaseName("ix_tracked_actions_owner_user_id");

                    b.HasIndex("ProposedActionId")
                        .IsUnique()
                        .HasDatabaseName("ix_tracked_actions_proposed_action_id");

                    b.HasIndex("DueDate", "Status")
                        .HasDatabaseName("ix_tracked_actions_due_date_status");

                    b.ToTable("tracked_actions");
                });
            ...
            modelBuilder.Entity("ActionLedger.Domain.Webhooks.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SubscriptionId")
                        .HasDatabaseName("ix_outbox_messages_subscription_id");

                    b.HasIndex("State", "NextAttemptAt")
                        .HasDatabaseName("ix_outbox_messages_state_next_attempt_at");

                    b.ToTable("outbox_messages");
                });

            modelBuilder.Entity("ActionLedger.Domain.Webhooks.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ActionLedger.Domain.Actions.TrackedAction", b =>
                {
                    b.HasOne("ActionLedger.Domain.Users.User", null)
                        .WithMany()
                        .HasForeignKey("OwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_tracked_actions_users_owner_user_id");

                    b.HasOne("ActionLedger.Domain.Extraction.ProposedAction", null)
                        .WithMany()
                        .HasForeignKey("ProposedActionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tracked_actions_proposed_actions_proposed_action_id");
                });
            ...
            modelBuilder.Entity("ActionLedger.Domain.Webhooks.OutboxMessage", b =>
                {
                    b.HasOne("ActionLedger.Domain.Webhooks.WebhookSubscription", null)
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_outbox_messages_webhook_subscriptions_subscription_id");
                });
