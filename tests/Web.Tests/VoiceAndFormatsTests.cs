...
public sealed class VoiceAndFormatsTests
{
    ...
    public static TheoryData<string, string> VoiceConstants => new()
    {
        ...
        { nameof(Voice.ReviewProposals), "Review proposals" },
        { nameof(Voice.Review), "Review" },
        { nameof(Voice.MetaSeparator), " \u00B7 " },
        { nameof(Voice.ProposedByAi), "Proposed by AI" },
        { nameof(Voice.DecidedByPrefix), "Decided by " },
        { nameof(Voice.Owner), "Owner" },
        { nameof(Voice.DueDate), "Due date" },
        { nameof(Voice.Unassigned), "Unassigned" },
        { nameof(Voice.AiSuggestedPrefix), "AI suggested: " },
        { nameof(Voice.AiSuggestedNone), "none" },
        { nameof(Voice.NoDueDateProposed), "No due date proposed" },
        { nameof(Voice.NoDueDate), "No due date" },
        { nameof(Voice.Proposed), "Proposed" },
        { nameof(Voice.ReasonPrefix), "Reason: " },
        { nameof(Voice.NoReasonGiven), "No reason given" },
        { nameof(Voice.ViewAction), "View action" },
        { nameof(Voice.ViewActions), "View actions" },
        { nameof(Voice.ProposalsPendingSuffix), " proposals pending" },
        { nameof(Voice.OneProposalPending), "1 proposal pending" },
        { nameof(Voice.AllProposalsDecided), "All proposals decided" },
